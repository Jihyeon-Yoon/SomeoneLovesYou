 ...
 */
public class RecommandMusicEmotion5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.fragment_recommand_music_emotion5, null);
        ...
        try {
            InputStream is  = getResources().openRawResource(R.raw.music_e5);
